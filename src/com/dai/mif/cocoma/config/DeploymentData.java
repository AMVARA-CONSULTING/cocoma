...
public class DeploymentData {
    ...
    // Deploymentname used in Filesystem coming from deployment platform before copying to Cognos deployment folder
    ...
    // Deploymentname used in ZIP-Archive ... this is the original export archive name
    ...
    public void readConfig(XMLConfiguration conf, String configKey)
        ...
        this.name_set_datetime_suffix = conf.getString(configKey + ".name_set_datetime_suffix");
        ...
        try {
            ...
            if (!CoCoMa.isInteractiveMode()) {
                throw new CoCoMaConfigException(
                        "Error decrypting the deployment password: " + e.getMessage(),
                        e);
            } else {
                this.password = null;
            }
        ...
        this.runCureJar_searchPath = conf.getString(configKey + ".runCureJar_searchPath","");
        this.runCureJar_PackagePath = conf.getString(configKey + ".runCureJar_PackagePath","");
        ...
        // Read Delete items
        log.debug("Looking for config entry 'delete items': "+configKey+".delete_items.item");

		List deleteItemsDataList = conf
			.getList(configKey + ".delete_items.item");
		...
		log.debug("Found number of deleteItems config entries: "+this.deleteItems.size());
     ...
     *
     * @param status the new value to set for the status field
     */
	...
	/**
	 * @param deploymentNameOfArchiveInZipDeploymentFile the deploymentNameOfArchiveInZipDeploymentFile to set
	 */
	...
	/**
	 * @param deploymentTargetCognosPortalArchiveName the deploymentTargetCognosPortalArchiveName to set
	 */
	...
	/**
	 * @param deploymentTargetArchiveName the deploymentTargetArchiveName to set
	 */
	...
	/**
	 * @param deploymentSrcArchiveName the deploymentSrcArchiveName to set
	 */
	...
	/**
	 * @param deploymentTargetFolder the deploymentTargetFolder to set
	 */
