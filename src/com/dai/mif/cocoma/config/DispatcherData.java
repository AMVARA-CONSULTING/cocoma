...
public class DispatcherData {
    ...
    public DispatcherData(XMLConfiguration config, int i)
        ...
        this.globalDispatcher = conf.getBoolean(
                RECORD_KEY_PREFIX + "[@global]", false);

        this.dispatcherName = conf.getString(recordKey + ".name");
        this.loadBalancingMode = conf.getString(recordKey
                + ".loadBalancingMode");
        ...
        this.connectionsHighAffinity = conf.getString(recordKey
                + ".connectionsHighAffinity");
        this.connectionsLowAffinity = conf.getString(recordKey
                + ".connectionsLowAffinity");
        this.maxProcessesInteractiveReporting = conf.getString(recordKey
                + ".maxProcessesInteractiveReporting");
        this.queueTimeoutReporting = conf.getString(recordKey
                + ".queueTimeoutReporting");
        ...
        @SuppressWarnings("unchecked")
		List<Object> advancedParameters_listvalues = conf.getList(tempkey
                + ".value");

        String[][] advancedParameters_array = new String[advancedParameters_list
                .size()][2];
        ...
        for (int i_advSettingslist = 0; i_advSettingslist < advancedParameters_list
            ...
            log.debug("VALUE:"
                    + advancedParameters_listvalues.get(i_advSettingslist));

            // build key
            String tempkey_int = tempkey + "(" + i_advSettingslist + ")";
            log.debug("key: " + tempkey_int);
            // parameter name
            String adv_name = (String) advancedParameters_list
                    .get(i_advSettingslist); // conf.getString(tempkey_int+".name");
            ...
            // value
            String adv_value = (String) advancedParameters_listvalues
                    .get(i_advSettingslist); // conf.getString(tempkey_int+".value");
        ...
        // audit levels
        this.cmsAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.contentManagerService"));
        this.rdsAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.reportDataService"));
        this.emsAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.eventManagementService"));
        this.jsAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.jobService"));
        this.msAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.monitorService"));
        this.psAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.presentationService"));
        this.rsAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.reportService"));
        this.rsNativeQueryAudit = conf.getBoolean(recordKey
                + ".auditLevel.reportServiceNativeQuery", true);
        this.ssAuditLevel = parseAuditLevel(conf.getString(recordKey
                + ".auditLevel.systemService"));
        this.dispatcherAuditLevel = parseAuditLevel(conf.getString(recordKey
